...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/GiaHDuong/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/GiaHDuong/${id}/branches`)
      .then((response) => response.json())
      .then((data) => {
        setBranch(data);
      });
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/GiaHDuong/${id}/deployments`)
      .then((response) => response.json())
      .then((data) => {
        setDeployment(data);
      });
      ...
      <div className="repodetail-card">
        ...
        <p>
          ...
          {deployment.length === 0 ? (
            ...
            <a href={`https://GiaHDuong.github.io/${details.name}`}>
              GiaHDuong.github.io/{details.name}
            </a>
          )}
        </p>
        <p>
